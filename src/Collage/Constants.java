...
public class Constants {
    public String D1 = "What does Ariel, from the Little Mermaid, give Ursula so that she can have her legs? ";
    public String[] Answer1 = {" Voice", "Money", " Hair", "Flounder"};
    public String D2 = "In what movie will you find a group of vegetarian sharks?";
    public String[] Answer2 = {"Finding Nemo", "The Little Mermaid", "Shark Tale", "Frozen"};


    public Constants() {

        Map<String, String[]> DisneyQs = new HashMap<String, String[]>();
